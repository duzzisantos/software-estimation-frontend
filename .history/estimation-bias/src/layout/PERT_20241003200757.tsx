...
const PERTAnalysis = ({ selectedTasks, setSelectedTasks }: FormSelection) => {
  ...
  return (
    <Col className="my-4 p-4">
      ...
      <Form className="d-flex flex-column gap-3 bg-light-subtle my-3 p-2 py-5">
        <h2>Provide Estimates</h2>
        <Col
          lg={6}
        ...
        {selectedTasks.length > 0 && (
          <Col className="bg-light-subtle py-3 d-flex flex-column gap-3 fw-normal border-top border-primary-subtle border-5 my-3">
