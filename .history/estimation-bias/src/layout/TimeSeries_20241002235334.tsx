...
interface FormSelection {
  selectedNewTasks: string[];
  setSelectedNewTask: Dispatch<SetStateAction<string[]>>;
}
    ...
    <Col className="my-4 p-4">
      ...
      <Form className="d-flex flex-column gap-3 bg-light-subtle my-3 p-2">
        ...
        <div className="d-flex flex-wrap gap-2">
          {selectedNewTasks.map((element, index) => (
            <TaskInput key={index} taskName={element.split("_").join(" ")} />
          ))}
        </div>
