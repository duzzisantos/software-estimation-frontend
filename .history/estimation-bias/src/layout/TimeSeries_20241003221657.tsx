...
import fetchDataTraining from "../utils/fetchDataTraining";
...
const TimeSeriesAnalysis = ({
  ...
  const postObject = () => {
    ...
    obj["last_updated"] = new Date(Date.now()).toISOString();
    return obj;
  };
  ...
  return (
    <Col className="my-4 p-4">
      ...
      >
        Retrain Time Series Data with TensorFlow and SciKit Learn
      </Button>
